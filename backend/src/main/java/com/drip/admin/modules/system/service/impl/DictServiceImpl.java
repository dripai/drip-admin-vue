...
public class DictServiceImpl extends ServiceImpl<SysDictTypeMapper, SysDictTypeEntity> implements DictService {
    ...
    public List<SysDictTypeEntity> types() {
        return list(new QueryWrapper<SysDictTypeEntity>().orderByDesc("created_at"));
    }
    ...
    @Override public SysDictTypeEntity typeDetail(long id) { SysDictTypeEntity entity = getById(id); if (entity == null) throw new BusinessException(404000, "operation failed"); return entity; }
