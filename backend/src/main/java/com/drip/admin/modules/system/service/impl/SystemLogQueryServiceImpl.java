...
public class SystemLogQueryServiceImpl extends ServiceImpl<SysLoginLogMapper, SysLoginLogEntity> implements SystemLogQueryService {
    ...
    @Override public SysLoginLogEntity loginLog(long id) { SysLoginLogEntity entity = getById(id); if (entity == null) throw new BusinessException(404000, "???????"); return entity; }
    ...
    @Override public SysOperationLogEntity operationLog(long id) { SysOperationLogEntity entity = operationLogMapper.selectById(id); if (entity == null) throw new BusinessException(404000, "???????"); return entity; }
