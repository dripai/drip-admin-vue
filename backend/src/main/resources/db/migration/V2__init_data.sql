...
(8, 2, '重置密码', 'BUTTON', null, null, 'system:user:resetPassword', null, 16, 0, 1),
(9, 2, '分配角色', 'BUTTON', null, null, 'system:user:assignRole', null, 17, 0, 1),
...
(20, 1, '登录日志', 'MENU', '/system/loginLogs', 'system/log/login', 'system:loginLog:list', 'log-in', 70, 1, 1),
(21, 1, '操作日志', 'MENU', '/system/operationLogs', 'system/log/operation', 'system:operationLog:list', 'file-clock', 80, 1, 1),
(22, 1, '在线用户', 'MENU', '/system/onlineUsers', 'system/online/index', 'system:online:list', 'monitor', 90, 1, 1),
